...
CREATE TABLE temp2(
    id INT(3) ZEROFILL PRIMARY KEY NOT NULL,
...
-- Insert These datas To your DATABASE --

CREATE DATABASE seven_code_tech;
USE seven_code_tech;
...
('WEB0002', 'William', 'Weber',     'Senior', 'Full-Stack',                 'M', 45, '1977-06-10', 40000000, 'william.weber@example.com'),
('AI0002', 'Amelia', 'Ingram',      'Senior', 'Artificial-Intelligence',    'F', 39, '1983-03-12', 66000000, 'amelia.ingram@example.com'),
('DB0002', 'Dylan', 'Baker',        'Senior', 'Data-Analyst',               'M', 42, '1980-07-28', 53000000, 'dylan.baker@example.com'),
...
('WEB0003', 'Walter', 'Wells',      'Junior', 'Full-Stack',                 'M', 25, '1998-11-20', 34000000, 'walter.wells@example.com'),
...
UPDATE employee SET first_name = 'Reynard', last_name = 'Suryananda' WHERE emp_id = 'WEB0002';

-- 6:48 - 11:10 (Breakfast),(Lecture) -- 
-- 17.00 - 17:27 --
UPDATE employee SET first_name = 'Nikolaus', last_name = 'Albert' WHERE emp_id = 'DB0002';
UPDATE employee SET first_name = 'Samuel',   last_name = 'Bennard' WHERE emp_id = 'WEB0003';
...
INSERT INTO lulusan(universitas)
VALUES ('Ghost');
UPDATE lulusan 
SET emp_id = 111
WHERE universitas LIKE 'Ghost';